        ...
        <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
            <div className="carousel-inner">
                <div className="carousel-item active" style={{ backgroundColor: "#141414", borderRadius: "20px", border: "2px solid #41cea7" }}>
                    <img className="d-block" style={{ height: "265px", width: "100%", borderRadius: "20px" }} src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/a69f03100699803.5f0e99d121f96.jpg" alt="First slide" />
                </div>
                ...
                <div className="carousel-item" style={{ backgroundColor: "#f4f4f4", borderRadius: "20px", border: "2px solid #9c93ae" }}>
                    <img className="d-block" style={{ height: "265px", width: "100%", borderRadius: "20px" }} src="https://www.bajajmall.in/emistore/media/manufacturerimages/1688556669_SMF721BLVEINU_1.jpeg" alt="Fourth slide" />
                </div>
            </div>
